namespace Auth0 {
	...
	interface A0UserAPIClient {
		...
		[Export ("initWithRouter:idToken:")]
		IntPtr Constructor (A0APIRouter router, string idToken);
		...
		[Export ("initWithClientId:tenant:idToken:")]
		IntPtr Constructor (string clientId, string tenant, string idToken);
	...
	[BaseType (typeof (NSObject))]
	interface A0UserProfile : NSCoding {
	...
	[BaseType (typeof (NSObject))]
	interface A0AuthParameters : NSCopying {
	...
	[BaseType (typeof (NSObject))]
	interface A0UserIdentity : NSCoding {
